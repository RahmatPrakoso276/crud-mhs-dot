                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $dataMahasiswa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($mahasiswa->nim); ?></td>
                                            <td><?php echo e($mahasiswa->name); ?></td>
                                            <td><?php echo e($mahasiswa->whatsapp); ?></td>
                                            <td><?php echo e(optional($mahasiswa->prodi)->nama ?? 'N/A'); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#deleteModal" data-id="<?php echo e($mahasiswa->id); ?>">
                                                    Hapus
                                                </button>
...
<?php /**PATH C:\xampp\htdocs\laravel8\CRUD-Mhs\resources\views/mahasiswa/index.blade.php ENDPATH**/ ?>