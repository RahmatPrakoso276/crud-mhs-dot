            ...
            <div class="col-lg-12 ">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action=<?php echo e(route('mahasiswa.update', $mahasiswa->id)); ?>>
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name"
                                        value="<?php echo e($mahasiswa->name); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="whatsapp"
                                        value="<?php echo e($mahasiswa->whatsapp); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" name="prodi_id">
                                        <option selected value=<?php echo e(optional($mahasiswa->prodi)->id ?? 'null'); ?>>
                                            <?php echo e(optional($mahasiswa->prodi)->nama ?? 'N/A'); ?>
                                        ...
                                        <?php $__currentLoopData = $dataProdi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($item->id !== $mahasiswa->prodi_id): ?>
...
<?php /**PATH C:\xampp\htdocs\laravel8\CRUD-Mhs\resources\views/mahasiswa/update.blade.php ENDPATH**/ ?>